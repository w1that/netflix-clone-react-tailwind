...
function LoginPage() {
  return (
    <div className="bg-black h-screen">
      <img
        className="absolute h-screen w-full filter object-cover brightness-50"
      ...
      <div className="relative h-20">
        ...
        <div className="bg-black bg-opacity-50 backdrop-filter text-white backdrop-brightness-50 w-1/4 h-96 mx-auto px-16 py-14 h-3/5 rounded">
            <div>
            <h1 className="text-4xl font-bold mb-7">Oturum Aç</h1>
            <input className="bg-gray-innerInput py-2 px-3 w-full text-center rounded-sm h-12 mb-3 text-left focus:outline-none focus:ring-2 focus:ring-netflixred focus:border-transparent" placeholder="Eposta ya da telefon numarası"></input>
            <input type="password" className=" bg-gray-innerInput py-2 px-3 w-full text-center rounded-sm h-12 mb-12 text-left focus:outline-none focus:ring-2 focus:ring-netflixred focus:border-transparent" placeholder="Parola"></input>
            <button className="bg-netflixred text-large font-medium text-white py-2 w-full hover:bg-netflixred-hover">Oturum Aç</button>
